...
app.get('/', async function (request, response) {
    ...
    const params = {
        ...
        'fields': 'cover.*, date, title, intro, status, district, slug, target_group, id',
    }
...
app.get('/:district', async function (request, response) {
    ...
    params.set('fields', 'cover.*, date, title, intro, status, district, slug, target_group, id')
...
app.get('/:district/:slug', async function (request, response) {
    ...
    const params = {
        ...
        // Alleen de volgende velden tonen, zodat we niet onnodig veel data ophalen
        'fields': 'id, cover.*, date, title, intro, status, district, slug, body, comments.*, target_group, id',
    }
    ...
    const featuredParams = {
        ...
        'fields': 'id, cover.*, date, title, intro, status, district, slug, body, comments.*, target_group',
    }
